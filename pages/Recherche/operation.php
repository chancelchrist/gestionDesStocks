...
<html lang="fr">
  ...
  <div class="jumbotron">
        ...
        <div class="container  register-form">
                ...
                <div class="form" >
                    <div class="note">
                    <p class> Cliquer juste sur l'operation que  vous souhaiter traiter</p>
                    </div>
                    <div class="form-content">
                        <div class="row align-items-start">
                          <div class="col-md-4">
                            <div class="form-content">
                              <h3 class="text-center">Comptabilite Journaliere</h3>
                              <p class="text-center"> Cette option vous permet d'afficher l'ensemble des ventes pour une date donnees   </p>
                              <p class="text-center"><a class="btn btn-primary" href="total_vente.php" role="button">Valider &raquo;</a></p>
                            </div>
                            <div class="form-content">
                              <h2>Salaire Manutance</h2>
                              <p>Cette option vous permet d'avoir la somme total en FCFA pour une journee precise</p>
